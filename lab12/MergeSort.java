...
public class MergeSort {
    ...
    private static <Item extends Comparable> Queue<Queue<Item>>
        ...
        for (Item i: items) {
            Queue<Item> qOfSingleItem = new Queue<>();
            qOfSingleItem.enqueue(i);
            qOfq.enqueue(qOfSingleItem);
        }
        return qOfq;
    }
    ...
    public static <Item extends Comparable> Queue<Item> mergeSort(
        ...
        while (sortedItems.size() != 1) {
            ...
            for (int i = 0; i < curSize / 2; i += 1) {
                sortedItems.enqueue(mergeSortedQueues(sortedItems.dequeue(),
                        sortedItems.dequeue()));
            }
        }
        return sortedItems.dequeue();
    }
